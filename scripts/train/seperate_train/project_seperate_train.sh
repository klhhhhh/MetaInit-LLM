...
torchrun \
    ...
    /u/klin4/MetaInit-LLM/training/seperate_projection_init_pretraining.py \
    --config-path=/u/klin4/MetaInit-LLM/conf \
    --config-name=megatron_gpt_350m_seperate_training_config \
    trainer.devices=4 \
    trainer.num_nodes=8 \
    trainer.max_epochs=null \
    trainer.max_steps=101000 \
    ...
    model.restore_from_path=/work/hdd/bdrw/klin4/run_gpt_350m_project_train_learnable_seperate/megatron_gpt/checkpoints_step_1_learn/step_1000 \
    ...
    exp_manager.exp_dir=/work/hdd/bdrw/klin4/run_gpt_350m_project_train_learnable_seperate \
    exp_manager.create_wandb_logger=True \
    exp_manager.wandb_logger_kwargs.project="project_train_350m" \
    exp_manager.wandb_logger_kwargs.name="run_learnable_step_2_learning_$SLURM_JOB_ID" \
    # exp_manager.wandb_logger_kwargs.id="sk4htb6d" \
    # exp_manager.wandb_logger_kwargs.resume="allow" \
    exp_manager.resume_if_exists=False \
    exp_manager.resume_ignore_no_checkpoint=True \
    exp_manager.create_checkpoint_callback=True \
    exp_manager.checkpoint_callback_params.dirpath=/work/hdd/bdrw/klin4/run_gpt_350m_project_train_learnable_seperate/megatron_gpt/checkpoints_step2_learn \
