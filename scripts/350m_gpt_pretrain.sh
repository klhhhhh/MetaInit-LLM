...
torchrun \
    ...
    exp_manager.exp_dir=/work/hdd/bdrw/klin4/run_gpt350m_compare_test \
    ...
    exp_manager.checkpoint_callback_params.dirpath=/work/hdd/bdrw/klin4/run_gpt350m_compare_test/megatron_gpt/checkpoints_$SLURM_JOB_ID \
